...
void Converter::transition(int type)
{
    ...
    switch (type) {
        case UPLOAD_SPEECH:
            fileName = "../humanSensing/dialogModule/speechTran.dat";
            break;
        case CONFIRM_TEXT:
            fileName = "../humanSensing/dialogModule/confirmTran.dat";
            break;
        case UPLOAD_HUM:
            fileName = "../humanSensing/dialogModule/speechHum.dat";
            break;
    }
...
void Converter::start()
{
    ...
    try{
        speech_recog_pro->setLanguage("English");
...
bool Converter::witAI()
{
    ...
    char* cmd = "ssh nao@192.168.1.102 'bash -s' < ../humanSensing/dialogModule/upload.sh";
